...
def app():
    ...
    uploaded_file = st.file_uploader("Choose a CSV file with at least three column names: 'temperature', 'salinity', and 'pressure' and their corresponding values in the rows below:")
